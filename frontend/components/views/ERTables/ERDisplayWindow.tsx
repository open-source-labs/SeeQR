...
/**
 * ACTION MAP
 * This is dynamic since we imported as * we have access to all functions! -> Deprecated with redux migration
 */
...
function ERTabling({ tables, selectedDb, curDBType }: ERTablingProps) {
  ...
  const handleAddTable = (): void => {
    const schemaStateCopy: SchemaStateObjType = JSON.parse(
